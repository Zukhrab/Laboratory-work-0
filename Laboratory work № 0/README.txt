...
Упорядочить полученную последовательность по возрастанию количества цифр в записи чисел. 
Вывести исходную последовательность, а также полученную последовательность до сортировки и после сортировки на экран.
